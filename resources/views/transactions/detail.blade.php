<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Transaction &raquo; {{ $item->coffee->name }} by {{ $item->user->name }}
        </h2>
    </x-slot>
            ...
            <div class="w-full rounded overflow-hidden shadow-lg px-6 py-6 bg-white">
                <div class="flex flex-wrap -mx-4 -mb-4 md:mb-0">
                    <div class="w-1/4 px-4 mb-4 md:mb-0">
                        <img src="{{ $item->coffee->picturePath }}" alt="" class="w-1/2 md:w-full rounded">
                    </div>
                    <div class="w-3/4 px-4 mb-4 md:mb-0">
                        <div class="flex flex-wrap mb-3">
                            <div class="w-1/4">
                                <div class="text-sm">Product Name</div>
                                <div class="text-xl font-bold">{{ $item->coffee->name }}</div>
                            </div>
                            <div class="w-1/4">
                        ...
                        <div class="flex flex-wrap mb-3">
                            <div class="w-4/4">
                                ...
                                <div class="text-lg">
                                    <div class="text-xl font-bold">{{ $item->description }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-wrap mb-3">
